...
interface IExperience {
    ...
    company?: ILocalizedText;
    university?: ILocalizedText;
    duration: ILocalizedText;
}

type ParialIAPP_DATA = Partial<IAPP_DATA>;

export const APP_DATA: ParialIAPP_DATA = {
    FACEBOOK_URL: 'https://www.facebook.com/ntienan2502/',
};
...
export const EXPERIENCES: IExperience[] = [
    {
        ...
        university: {
            vi: 'Dai hoc Mo Ha Noi',
            en: 'Hanoi Open University',
        },
        duration: {
            vi: '2023-2024',
            en: '2023-2024',
